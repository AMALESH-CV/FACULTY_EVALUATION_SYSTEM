...
Class Action {
	...
	function save_teaching_hours(){
		...
		$data .= ", practical_engaged = $practical_engaged ";
		...
		$save = $this->db->query("INSERT INTO teaching_hours set $data");
		if($save){
	...
	function save_syllabus(){
		...
		$data .= ", hours_engaged = $hours_engaged ";
		...
		$save = $this->db->query("INSERT INTO syllabus_enrichment set $data");
		if($save){
	...
	function save_innovative(){
		...
		$save = $this->db->query("INSERT INTO innovative_teaching set $data");
		if($save){
		...
		$data .= ", conference_publication = $conference_publication ";
		$data .= ", indexed_journal_publication = $indexed_journal_publication ";
		$data .= ", short_term_courses_attended = $short_term_courses_attended ";
		$data .= ", certificate_programs_attended = $certificate_programs_attended ";
		$data .= ", seminars_attended = $seminars_attended ";
		$data .= ", seminars_conducted = $seminars_conducted ";
		$data .= ", projects_suggested = $projects_suggested ";
		...
		$save = $this->db->query("INSERT INTO teacher_fdp_activities set $data");
		if($save){
