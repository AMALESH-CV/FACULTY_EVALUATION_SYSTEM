...
if($action == 'save_teaching_hours'){
	$save = $crud->save_teaching_hours();
	if($save)
		echo $save;
}

if($action == 'save_add_on_teaching'){
	$save = $crud->save_add_on_teaching();
	if($save)
		echo $save;
}

if($action == 'save_syllabus'){
	$save = $crud->save_syllabus();
	if($save)
		echo $save;
}

if($action == 'save_innovative'){
	$save = $crud->save_innovative();
	if($save)
		echo $save;
}
